      ...
      <div className="flex flex-col xl:grid xl:grid-cols-3 gap-10">
        {latestNews.length && (
          ...
          >
            ...
            />
            <div className="absolute bottom-0 text-gray-700 p-5 xl:p-10 bg-gradient-to-t from-black">
              <h1 className="text-xl xl:text-5xl md:line-clamp-2 text-gray-200">
                {latestNews[0].title}
              </h1>
              <div className="mt-10 text-sm line-clamp-4 xl:text-2xl md:line-clamp-4 text-gray-300">
